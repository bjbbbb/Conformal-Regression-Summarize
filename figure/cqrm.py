...
from torchcp.regression.predictors import CQRM
...
def visualize_predictions(predictions_file, run_number=None):
    ...
    plt.savefig(f"cqrm_synthetic.pdf", dpi=300, bbox_inches='tight', format='pdf')
    print(f"cqrm{run_suffix}.pdf")
    plt.close()
